...
class MapPiece extends React.Component {
  ...
  newBrunswickExplanation() {
    if (this.props.selectedEnergy === 'electricity'
      && this.props.name === 'NB') {
      const scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 280 : 270
  ...
  emersonExplanation() {
    ...
    const scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 150 : 169
  ...
  cngExplanation() {
    ...
    const scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? -74 : -113
    const scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? 255 : 270
    return (<g>
      <ExplanationDot
  ...
  lngExplanation() {
    ...
    const scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? -117 : -163
    const scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? 235 : 250
    return (<g>
      <ExplanationDot
  ...
  albertaExplanation() {
    ...
    let scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 250 : 225
    let scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? 16 : 20
    if (this.props.arrangeBy === 'location') {
      scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 247 : 217
      scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? -16 : -20
    }
    return (<g>
      <ExplanationDot
        scale="scale(1 -1) translate(0 -100)"
  ...
  atlqExplanation() {
    ...
    if (this.props.arrangeBy === 'amount') {
      scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 247 : 215
      scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? 20 : 23
    }
    return (<g>
      <ExplanationDot
        scale="scale(1 -1) translate(0 -100)"
  ...
  render() {
    ...
    if (this.props.selectedEnergy === 'naturalGas') {
      scaleContainerX = this.props.viewport.get('changeWidthRatio') > 1.2 ? 185 : 195
      scaleContainerY = this.props.viewport.get('changeHeightRatio') > 1.2 ? 270 : 240
      containerX = this.props.x1 * MapLayoutGridConstant.getIn(['naturalGas', 'mapPieceScale'], 1) + scaleContainerX
      containerY = this.props.y1 * MapLayoutGridConstant.getIn(['naturalGas', 'mapPieceScale'], 1) + scaleContainerY
    }
