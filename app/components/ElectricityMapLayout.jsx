...
class ElectricityMapLayout extends React.Component {
  ...
  getPowerPoolsOutline(key, country, xaxis, yaxis, position, dimensions, mapPieceScale){
    if(this.isMapPieceSelected(key, country) && country === 'powerpool' && this.props.arrangeBy === 'location'){
      ...
      switch(key){
        case 'NE-ISO':
          result= <polygon className="powerPoolOutline" points="121.5,148.5 143.7,139.3 166,148.5 166,175.3 187.7,186.8 210.5,175.3 232.6,186.5 255.7,175.3 
          ...
          break;
        case 'MN/ND':
          result = <polygon className="powerPoolOutline" points="154.5,149.5 176.8,140.3 198.8,149.5 221,140.3 243.7,149.5 243.7,176.3 221,187.8 198.8,175.8 
                    176.8,187.8 154.5,176.4 "/>
          break;
        case 'PJMPP':
          result= <polygon className="powerPoolOutline" points="144.3,128.1 167,118.9 189,128.2 211.2,118.9 233.2,128.2 233.2,155.1 255.6,167.5 255.6,194.3 
