...
class MenuBarOption extends React.Component {
  render() {
      ...
      if(key === this.props.selectedOption){
        return <g key = {key}>
            <text x = {this.props.optionXaxisPadding} y = {yaxis} className='SelectedMenuBarOption'> 
              {Tr.getIn([this.props.trKey, key, this.props.lang])} 
            </text>
            <TriangularTabLine yaxis={yaxis} color= {this.props.color} lineWidth={this.props.lineWidth}/>
          </g>
      }
      return <g key = {key} onClick = { this.props.onOptionClick.bind(this, key)}> <text x = {this.props.optionXaxisPadding} y = {yaxis}> 
      	{Tr.getIn([this.props.trKey, key, this.props.lang])} 
      </text> </g>
    })
  }
