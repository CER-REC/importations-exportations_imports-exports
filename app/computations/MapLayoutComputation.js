...
MapLayoutComputation.getLayout = function(type='location', layoutConstant, data, columns){
  switch(type){
  case 'export':
    return MapLayoutComputation.createSortedLayout(data.sort((a,b) => MapLayoutComputation.sortData(a, b, 'exportData')), columns)
  case 'import':
    return MapLayoutComputation.createSortedLayout(data.sort((a,b) => MapLayoutComputation.sortData(a, b, 'importData')), columns)
  case 'location':
  default:
